...
evaluation fixtures, read-only workspace sessions, and facility-equipment/compatible-stock
executors exist. The other query domains, model planning, tracing, and the repeatable
query evaluation command remain to be implemented. See
