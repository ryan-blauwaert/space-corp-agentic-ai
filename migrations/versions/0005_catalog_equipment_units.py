...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_facilities_workspace_id", "facilities", ["workspace_id", "id"])
    op.create_table(
        "catalog_releases",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("catalog_release_id", "code", name="uq_equipment_models_release_code"),
        sa.UniqueConstraint("catalog_release_id", "id", name="uq_equipment_models_release_id"),
    )
    op.create_table(
        "equipment_units",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.UniqueConstraint("workspace_id", "id", name="uq_equipment_units_workspace_id"),
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index("ix_equipment_units_workspace_facility_status", table_name="equipment_units")
