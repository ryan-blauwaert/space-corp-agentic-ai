...
class IncidentQuery(PaginationQuery):
    ...
    occurred_from: AwareDatetime | None = Field(
        default=None, description="Inclusive occurrence-time lower bound; timezone required."
    )
    occurred_before: AwareDatetime | None = Field(
        default=None,
